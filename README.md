...
<p align="center">
    <a href="https://github.com/Ice-Hazymoon/ToolMixer/blob/master/LICENSE">
        <img src="https://img.shields.io/github/license/Ice-Hazymoon/ToolMixer.svg" alt="MIT License" />
    </a>
...
Q: 我可以参与开发 ToolMixer 吗？  
A: 当然可以，随时欢迎提交 PR，会视情况添加到 [ToolMixer](https://miku.tools) 主站

Q: 我能给 ToolMixer 提新功能吗？  
A: issues 区随时欢迎你。

Q: ToolMixer 的主要技术栈是什么？  
...
[MIT](https://github.com/Ice-Hazymoon/ToolMixer/blob/master/LICENSE)
